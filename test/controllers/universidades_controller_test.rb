...
class UniversidadesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create universidade" do
    assert_difference('Universidade.count') do
      post universidades_url, params: { universidade: { cpf: @universidade.cpf, matricula: @universidade.matricula, nome: @universidade.nome, sobrenome: @universidade.sobrenome } }
    end
  ...
  test "should update universidade" do
    patch universidade_url(@universidade), params: { universidade: { cpf: @universidade.cpf, matricula: @universidade.matricula, nome: @universidade.nome, sobrenome: @universidade.sobrenome } }
